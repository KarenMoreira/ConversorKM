...
public class MainActivityKM extends AppCompatActivity {
    ...
    final private double factorDolarPeso = 0.54;
    ...
    public void clickConvertir(View v){
        ...
        }else
        {
            ...
            Toast.makeText(MainActivityKM.this, "Las opciones elegidas no tienen un factor de conversión",Toast.LENGTH_SHORT).show();
        }
    }
